...
public class StringObservablesFragment
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View layout = inflater.inflate(R.layout.fragment_string_observables, container, false);
        ButterKnife.inject(this, layout);
        return layout;
    }

    @OnClick(R.id.btn_by_line_operation)
    public void byLineOperation() {

        _progress.setVisibility(View.VISIBLE);
        _log("By Line Clicked");
        StringObservable.byLine(Observable.just("abc", "def", "efg")).subscribe(_getStringObserver());
    }

    @OnClick(R.id.btn_split_operation)
