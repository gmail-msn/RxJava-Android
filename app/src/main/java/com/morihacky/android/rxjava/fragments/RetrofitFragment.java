...
import com.morihacky.android.rxjava.utils.RxUtils;
...
public class RetrofitFragment
    ...
    @InjectView(R.id.demo_retrofit_contributors_username)
    EditText _username;
    @InjectView(R.id.demo_retrofit_contributors_repository)
    EditText _repo;
